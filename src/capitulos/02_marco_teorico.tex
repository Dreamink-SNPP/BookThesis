...
La sistematización del proceso creativo constituye un área de estudio fundamental en la investigación sobre guionismo y narrativa audiovisual. Según la literatura académica reciente sobre guión transmedia, la sistematización del proceso creativo se entiende como la estructuración metodológica de las fases de desarrollo narrativo, especialmente aquellas que anteceden a la redacción del guion literario \parencite{guion_transmedia_sistematizacion}.

Este proceso de sistematización cobra particular relevancia en la fase de pre-escritura, entendida como el conjunto de actividades previas a la redacción formal del guion literario. \textcite{field2005} establece que la organización sistemática de elementos narrativos mediante el paradigma estructural es fundamental antes de iniciar la escritura del guion. En este sentido, la pre-escritura comprende la gestión de personajes, locaciones, ideas y estructuras dramáticas que posteriormente configurarán el relato audiovisual.

\textcite{mckee1997}, por su parte, enfatiza la importancia de los procesos de organización narrativa como fundamento de la construcción dramática efectiva. McKee sostiene que la comprensión profunda de la estructura narrativa y la organización consciente de sus elementos constituyen pilares esenciales para el desarrollo de historias coherentes y significativas.

El modelo de proceso creativo propuesto por \textcite{koestler1964} identifica tres fases fundamentales que resultan aplicables al contexto de la pre-escritura de guiones: la fase lógica (definición del problema y planificación), la fase intuitiva (desarrollo creativo y exploración de ideas) y la fase crítica (verificación y refinamiento). Este modelo teórico proporciona un marco conceptual para comprender cómo los guionistas organizan y sistematizan su trabajo creativo.

La literatura profesional contemporánea sobre escritura de guiones reconoce la importancia de la organización en el proceso creativo. Diversos autores destacan que la estructuración sistemática del material narrativo durante la fase de pre-escritura no solo mejora la eficiencia del proceso, sino que también contribuye a la calidad final del producto audiovisual \parencite{finaldraft_organization, masterclass_screenplay_structure}.

En el contexto de la práctica profesional, los métodos de sistematización pueden incluir diversas herramientas y técnicas: desde el uso de tarjetas de colores para organizar secuencias, hasta la elaboración de documentos como loglines, sinopsis, escaletas y tratamientos. La investigación sobre procesos creativos de guionistas profesionales revela una amplia variedad de enfoques personalizados, cada uno adaptado a las necesidades específicas del creador y del proyecto \parencite{industrialscripts_writing_process, screencraft_process}.

La estructura dramática, elemento central de la organización narrativa, se conceptualiza como la disposición secuencial de eventos, personajes y conflictos dentro de un marco temporal y causal coherente. \textcite{field1979} propuso el paradigma de tres actos —configuración, confrontación y resolución— como sistema básico de organización, mientras que \textcite{gulino2004} profundizó en la estructuración mediante secuencias como unidades narrativas intermedias.

Es importante destacar que la sistematización del proceso de pre-escritura no implica necesariamente rigidez creativa, sino más bien la adopción de métodos organizativos que faciliten la materialización de ideas narrativas complejas. Como señalan diversos estudios sobre procesos creativos, la flexibilidad metodológica y la adaptabilidad de los sistemas de organización a las características particulares de cada proyecto constituyen aspectos fundamentales de la práctica profesional contemporánea \parencite{reedsy_story_structure, masterclass_narrative_structure}.

En el contexto latinoamericano y específicamente hispanohablante, la sistematización del proceso creativo ha sido abordada desde diversas perspectivas académicas y profesionales, destacándose la importancia de las etapas de inspiración, desarrollo y estructuración como fases diferenciadas del proceso creativo aplicado a la escritura de guiones \parencite{espaciocreacine_proceso, espaciocreacine_inspiracion}.
...
La \textbf{Ley N° 6106}, promulgada en 2018, establece el marco legal específico para el fomento y desarrollo del sector audiovisual en Paraguay \parencite{ley_6106_paraguay}. Esta normativa reconoce explícitamente la centralidad del guionista en el proceso creativo audiovisual, definiéndolo como la persona natural que es autora del guion que sirve de base creativa para la realización de la obra audiovisual. Esta definición legal reconoce el guion como elemento fundacional del proceso de producción, estableciendo derechos de autor específicos para quienes desarrollan estas obras literarias previas a la filmación.

La ley establece además mecanismos de incentivo y protección para la producción audiovisual nacional, incluyendo el reconocimiento de los derechos morales y patrimoniales de los guionistas sobre sus creaciones. En el contexto del presente estudio, esta normativa respalda jurídicamente la relevancia de investigar los procesos de sistematización de la pre-escritura, pues reconoce formalmente que el guion constituye la base creativa protegible de toda obra audiovisual, tanto en su versión literaria final como en sus fases previas de desarrollo narrativo.
