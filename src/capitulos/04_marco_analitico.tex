...
\begin{table}[ht]
	...
	\begin{tabular}{|l|c|c|c|p{4.5cm}|}
		...
		Cuaderno/Libreta & $\bullet$ & $\bullet$ & $\bullet$ & Captura inicial, exploración creativa \\ \hline

		Post-its/Tarjetas & $\bullet$ & $\bullet$ & $\bullet$ & Visualización de estructura en pared \\ \hline

		Celular (notas/audio) & $\bullet$ & $\bullet$ & $\bullet$ & Captura espontánea de ideas \\ \hline

		Standard Notes & $\bullet$ &  &  & Organización con carpetas categorizadas \\ \hline

		Notepad++ & $\bullet$ &  &  & Edición de texto plano \\ \hline

		Google Docs &  & $\bullet$ &  & Colaboración, códigos de colores \\ \hline

		Notion &  & $\bullet$ & $\bullet$ & Organización de biblia del proyecto \\ \hline

		Final Draft &  & $\bullet$ &  & Escritura de guion (software propietario) \\ \hline

		WriterDuet &  &  & $\bullet$ & Escritura de guion (versión gratuita) \\ \hline

		Kit Scenarist &  &  & $\bullet$ & Escritura de guion (open source) \\ \hline

		Pinterest &  & $\bullet$ & $\bullet$ & Referencias visuales \\ \hline

		Google Maps &  &  & $\bullet$ & Locaciones reales (Street View) \\ \hline
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{7cm}|c|c|c|c|}
		...
		Falta de visualización integrada de elementos & $\bullet$ & $\bullet$ & $\bullet$ & 3/3 \\ \hline

		Dispersión de información en múltiples herramientas & $\bullet$ & $\bullet$ & $\bullet$ & 3/3 \\ \hline

		Falta de vinculación dinámica entre elementos narrativos y guion & $\bullet$ & $\bullet$ & $\bullet$ & 3/3 \\ \hline

		Pérdida de flujo creativo al cambiar entre aplicaciones &  & $\bullet$ & $\bullet$ & 2/3 \\ \hline

		Software especializado demasiado complejo (Scrivener) &  & $\bullet$ & $\bullet$ & 2/3 \\ \hline

		Dificultad para reordenar estructura fácilmente (limitación de pizarra física) & $\bullet$ &  & $\bullet$ & 2/3 \\ \hline

		Dificultad para organizar/transcribir ideas capturadas en celular & $\bullet$ & $\bullet$ &  & 2/3 \\ \hline

		Herramientas de escritura pésimas para pensar creativamente &  & $\bullet$ &  & 1/3 \\ \hline

		Software propietario costoso (Final Draft) &  &  & $\bullet$ & 1/3 \\ \hline
	\end{tabular}
