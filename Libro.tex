...
\begin{document}
	...
	\subsubsection{Delimitaciones de Tiempo}

	Este trabajo de investigación se realizará en un límite temporal, para la cual tratará de analizar, diseñar, desarrollar y probar en un determinado tiempo. Se ha considerado que se realizará entre el mes de marzo hasta noviembre del 2025.

	\subsubsection{Delimitaciones Geográficas}
