...
\begin{document}
	...
	La implementación de un sistema Open Source para estructuración dramática, con exportación nativa a Fountain, reducirá en un 40\% el tiempo de conceptualización-preproducción y mejorará la coherencia narrativa en proyectos audiovisuales independientes.
	...
	\begin{enumerate}
		...
		\item Asegurar que la plataforma pueda exportar estos elementos directamente al formato Fountain para facilitar su integración en softwares de escritura de guiones.
