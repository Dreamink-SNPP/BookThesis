...
\begin{document}
	...
	Este sistema tendrá las siguientes limitaciones:

	\begin{itemize}[label=\textbullet, leftmargin=1.5cm, itemsep=0.8em]
		\item Funcionará por web.
		\item Será solamente de uso local.
		\item Será solamente mono-usuario y no colaborativo en multiusuario.
		\item No tendrá manejo de usuarios.
		\item Solamente podrá exportar a formato Foutain.
		\item No podrá importar formatos privativos (como FadeIn, Final Draft, WriterDuet, etc.).
		\item Solamente permitirá la estructuración previa del guion, no el guion literario.
		\item No realizará el guion técnico.
		\item La vista web será enfocada para monitores de computador, y no para dispositivos móviles.
		\item No tendrá implementación con LLMs o algún parecido.
	\end{itemize}
