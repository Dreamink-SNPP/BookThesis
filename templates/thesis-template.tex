...
% Unicode character mapping for checkboxes
\usepackage{newunicodechar}
\newunicodechar{☐}{\(\square\)}      % U+2610 Ballot Box (unchecked)
\newunicodechar{☑}{\(\boxtimes\)}    % U+2611 Ballot Box with Check
\newunicodechar{☒}{\(\boxtimes\)}    % U+2612 Ballot Box with X
